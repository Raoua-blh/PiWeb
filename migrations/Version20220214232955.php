 ...
 */
final class Version20220214232955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach CHANGE level level INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach CHANGE level level INT DEFAULT NULL, CHANGE nom_coach nom_coach VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
