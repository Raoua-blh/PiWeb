...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder70404 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6bebe = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties7a35d = [
        
    ];

    public function getConnection()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getConnection', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getMetadataFactory', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getExpressionBuilder', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'beginTransaction', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getCache', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getCache();
    }

    public function transactional($func)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'transactional', array('func' => $func), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'wrapInTransaction', array('func' => $func), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'commit', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->commit();
    }

    public function rollback()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'rollback', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getClassMetadata', array('className' => $className), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'createQuery', array('dql' => $dql), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'createNamedQuery', array('name' => $name), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'createQueryBuilder', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'flush', array('entity' => $entity), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'clear', array('entityName' => $entityName), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->clear($entityName);
    }

    public function close()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'close', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->close();
    }

    public function persist($entity)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'persist', array('entity' => $entity), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'remove', array('entity' => $entity), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'refresh', array('entity' => $entity), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'detach', array('entity' => $entity), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'merge', array('entity' => $entity), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getRepository', array('entityName' => $entityName), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'contains', array('entity' => $entity), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getEventManager', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getConfiguration', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'isOpen', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getUnitOfWork', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getProxyFactory', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'initializeObject', array('obj' => $obj), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'getFilters', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'isFiltersStateClean', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'hasFilters', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return $this->valueHolder70404->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer6bebe = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder70404) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder70404 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder70404->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, '__get', ['name' => $name], $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        if (isset(self::$publicProperties7a35d[$name])) {
            return $this->valueHolder70404->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder70404;
    ...
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;
    ...
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, '__isset', array('name' => $name), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;
    ...
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, '__unset', array('name' => $name), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;
    ...
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, '__clone', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        $this->valueHolder70404 = clone $this->valueHolder70404;
    }

    public function __sleep()
    {
        $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, '__sleep', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;

        return array('valueHolder70404');
    }
    ...
    {
        $this->initializer6bebe = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer6bebe;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer6bebe && ($this->initializer6bebe->__invoke($valueHolder70404, $this, 'initializeProxy', array(), $this->initializer6bebe) || 1) && $this->valueHolder70404 = $valueHolder70404;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder70404;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder70404;
    }
}
